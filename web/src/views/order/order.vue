      ...
      <a-form :model="paidForm" layout="vertical">
        <template v-if="paidInfoTemplate === 'alipayMck'">
          <a-form-item
            field="ref_hash"
            label="交易订单号（选填）"
            :rules="[{ maxLength: 128, message: '交易订单号不能超过128位' }]"
          >
          ...
          <a-form-item
            field="ref_from_info"
            label="付款方账号（选填）"
            :rules="[{ maxLength: 128, message: '付款方账号不能超过128个字符' }]"
          >
          ...
          <a-form-item
            field="ref_orderno"
            label="商家订单号（选填）"
            :rules="[{ maxLength: 128, message: '商家订单号不能超过128位' }]"
          >
        ...
        <template v-else-if="paidInfoTemplate === 'duolabaoQr'">
          ...
          <a-form-item
            field="ref_orderno"
            label="银行流水号（选填）"
            :rules="[{ maxLength: 128, message: '银行流水号不能超过128位' }]"
          >
